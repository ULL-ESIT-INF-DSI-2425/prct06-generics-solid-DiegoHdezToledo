...
describe('NumericPrintableCollection', () => {
  it('Inicializar coleccion de numeros', () => {
    const collection = new NumericPrintableCollection([1, 2, 3]);
    expect(collection.items).toEqual([1, 2, 3]);
  });

  it('Inicializar coleccion de numeros vacia', () => {
  ...
  it('Debe devolver el numero de items de una coleccion', () => {
    const collection = new NumericPrintableCollection([1, 2, 3]);
    expect(collection.getNumberOfItems()).toBe(3);
  });

  it('Debe devolver el numero de items de una coleccion vacia', () => {
    const collection = new NumericPrintableCollection([]);
